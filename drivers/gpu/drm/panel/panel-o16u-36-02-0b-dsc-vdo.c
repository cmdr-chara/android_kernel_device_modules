...
#define P20_FPS_INIT_INDEX 22
#define P20_GIR_INIT_INDEX1 23

#define LCM_P0_0 0x00
#define LCM_P0_1 0x11
#define LCM_P1_0 0x42
#define LCM_P1_1 0x53
#define LCM_P2_0 0x84
...
unsigned int panel_tm_nt37706_rc_buf_thresh[14] = {896, 1792, 2688, 3584, 4480, 5376, 6272, 6720, 7168, 7616,7744, 7872, 8000, 8064};
unsigned int panel_tm_nt37706_range_min_qp[15] = {0, 4, 5, 5, 7, 7, 7, 7, 7, 7, 9, 9, 9, 11, 17};
unsigned int panel_tm_nt37706_range_max_qp[15] = {8, 8, 9, 10, 11, 11, 11, 12, 13, 14, 15, 16, 17, 17, 19};
int panel_tm_nt37706_range_bpg_ofs[15] = {2, 0, 0, -2, -4, -6, -8, -8, -8, -10, -10, -12, -12, -12, -12};
...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0x3B, 0x0C, {0x00,0x30,0x00,0x38,0x00,0x30,0x03,0xA8,0x00,0x30,0x0B,0x38}},
	{0x6F, 0x01, {0x10}},
	{0x3B, 0x04, {0x00,0x30,0x00,0x38}},
	{0x88,0x09,{0x01,0x02,0x62,0x09,0x86,0x00,0x00,0x00,0x00}},
	...
	{0xF0, 0x05, {0x55,0xAA,0x52,0x08,0x00}},
	{0xBA, 0x07, {0x00,0x4F,0x00,0x30,0xC0,0x38,0x10}},
	{0x6F, 0x01, {0x34}},
	{0xDF, 0x01, {0x25}},
	{0xF0, 0x05, {0x55,0xAA,0x52,0x08,0x01}},
	{0x6F, 0x01, {0x03}},
	...
	{0xDF,0x02,{0x08,0x44}},
	{0x6F,0x01,{0x37}},
	{0xDF,0x03,{0x00,0x0A,0x0F}},

	{0xF0,0x05,{0x55,0xAA,0x52,0x08,0x08}},
	{0x6F,0x01,{0xCF}},
	{0xBC,0x03,{0x01,0x11,0x00,0xB6,0x01,0x11,0x00,0x44}},

	{0xF0,0x05,{0x55,0xAA,0x52,0x08,0x00}},
	{0x6F,0x01,{0x8B}},
	{0xDF,0x06,{0x3B,0x5C,0x3B,0x5C,0x3B,0x5C}},
	{0x6F,0x01,{0x91}},
	{0xDF,0x06,{0x00,0x00,0x25,0x8C,0x00,0x00}},
	{0x6F,0x01,{0x97}},
	{0xDF,0x06,{0x36,0x0A,0x36,0x0A,0x36,0x0A}},
	...
	{0xCB,0x0F,{0x26,0x05,0x0F,0x1D,0x78,0xE1,0x00,0x08,0x66,0x11,0x46,0x47,0x7F,0xFF,0xA0}},
	{0xD2,0x06,{0x15,0x15,0x15,0x15,0x15,0x10}},
	{0x6F,0x01,{0x06}},
	{0xD2,0x06,{0x50,0x2A,0x26,0x26,0x18,0x10}},
	{0x6F,0x01,{0x0C}},
	{0xD2,0x06,{0x70,0x28,0x22,0x22,0x20,0x1C}},
	{0x6F,0x01,{0x12}},
	{0xD2,0x06,{0x60,0x60,0x50,0x50,0x22,0x1D}},
	{0x6F,0x01,{0x18}},
	{0xD2,0x06,{0x80,0x80,0x40,0x48,0x18,0x00}},
	{0x6F,0x01,{0x1E}},
	{0xD2,0x06,{0x15,0x15,0x15,0x15,0x15,0x10}},
	{0x6F,0x01,{0x24}},
	{0xD2,0x06,{0x50,0x2A,0x26,0x26,0x18,0x10}},
	...
	{0x6F,0x01,{0xAE}},
	{0xD2,0x06,{0x80,0x80,0x40,0x48,0x18,0x00}},
	{0xD4,0x06,{0x15,0x15,0x15,0x15,0x15,0x10}},
	{0x6F,0x01,{0x06}},
	{0xD4,0x06,{0x50,0x2A,0x26,0x26,0x18,0x10}},
	{0x6F,0x01,{0x0C}},
	{0xD4,0x06,{0x70,0x28,0x22,0x22,0x20,0x1C}},
	{0x6F,0x01,{0x12}},
	{0xD4,0x06,{0x60,0x60,0x50,0x50,0x22,0x1D}},
	{0x6F,0x01,{0x18}},
	{0xD4,0x06,{0x80,0x80,0x40,0x48,0x18,0x00}},
	{0x6F,0x01,{0x1E}},
	{0xD4,0x06,{0x15,0x15,0x15,0x15,0x15,0x10}},
	{0x6F,0x01,{0x24}},
	{0xD4,0x06,{0x50,0x2A,0x26,0x26,0x18,0x10}},
...
static struct LCM_setting_table p20_init_setting[] = {
	{0xF0,0x05,{0x55,0xAA,0x52,0x08,0x03}},
	{0xC6,0x01,{0x80}},
	{0xFF,0x04,{0xAA,0x55,0xA5,0x80}},
	{0x6F,0x01,{0x08}},
...
static const char *panel_name = "panel_name=dsi_o16u_36_02_0b_dsc_vdo";
...
static struct LCM_setting_table lcm_aod_high_mode_with_lhbm_alpha[] = {
	{0x5F, 01, {0x00} },
	{0x51, 06, {0x00,0xF2,0x00,0x00,0x03,0xFF}},
};

static struct LCM_setting_table lcm_aod_low_mode_with_lhbm_alpha[] = {
	{0x5F, 01, {0x00} },
	{0x51, 06, {0x00,0x14,0x00,0x00,0x01,0xFF}},
};
...
#endif
		if (init_setting_vdo[FPS_INIT_INDEX].cmd == 0x2F && p20_init_setting[P20_FPS_INIT_INDEX].cmd == 0x2F) {
			init_setting_vdo[FPS_INIT_INDEX].para_list[0] = 0x00;
			p20_init_setting[P20_FPS_INIT_INDEX].para_list[0] = 0x00;
		} else
			pr_info("%s: please check FPS_INIT_INDEX\n", __func__);
	} else if (ctx->dynamic_fps == 90) {
		if (init_setting_vdo[FPS_INIT_INDEX].cmd == 0x2F && p20_init_setting[P20_FPS_INIT_INDEX].cmd == 0x2F) {
			init_setting_vdo[FPS_INIT_INDEX].para_list[0] = 0x01;
			p20_init_setting[P20_FPS_INIT_INDEX].para_list[0] = 0x01;
		} else
			pr_info("%s: please check FPS_INIT_INDEX\n", __func__);
	} else if (ctx->dynamic_fps == 60) {
		if (init_setting_vdo[FPS_INIT_INDEX].cmd == 0x2F && p20_init_setting[P20_FPS_INIT_INDEX].cmd == 0x2F) {
			init_setting_vdo[FPS_INIT_INDEX].para_list[0] = 0x02;
			p20_init_setting[P20_FPS_INIT_INDEX].para_list[0] = 0x02;
		} else
			pr_info("%s: please check FPS_INIT_INDEX\n", __func__);
	}

	if (ctx->gir_status) {
		if (init_setting_vdo[GIR_INIT_INDEX1].cmd == 0x5F && p20_init_setting[P20_GIR_INIT_INDEX1].cmd == 0x5F) {
			init_setting_vdo[GIR_INIT_INDEX1].para_list[0] = 0x00;
			p20_init_setting[P20_GIR_INIT_INDEX1].para_list[0] = 0x00;
		} else
			pr_info("%s: please check GIR_INIT_INDEX1\n", __func__);
	} else {
		if (init_setting_vdo[GIR_INIT_INDEX1].cmd == 0x5F && p20_init_setting[P20_GIR_INIT_INDEX1].cmd == 0x5F) {
			init_setting_vdo[GIR_INIT_INDEX1].para_list[0] = 0x01;
			p20_init_setting[P20_GIR_INIT_INDEX1].para_list[0] = 0x01;
		} else
			pr_info("%s: please check GIR_INIT_INDEX1\n", __func__);
	}
#if 0
...
#endif
	if (build_id == LCM_P2_0)
		push_table(ctx, p20_init_setting, sizeof(p20_init_setting)/sizeof(struct LCM_setting_table));
	else
...
static struct mtk_panel_params ext_params_30hz = {
	...
	.dsc_params = {
		...
		.ext_pps_cfg = {
			.enable = 1,
			.rc_buf_thresh = panel_tm_nt37706_rc_buf_thresh,
			.range_min_qp = panel_tm_nt37706_range_min_qp,
			.range_max_qp = panel_tm_nt37706_range_max_qp,
			.range_bpg_ofs = panel_tm_nt37706_range_bpg_ofs,
			},
	},
	.data_rate = DATA_RATE,
	...
	.dyn_fps = {
		.switch_en = 1,
		.vact_timing_fps = 120,
		.dfps_cmd_table[0] = {0, 7, {0x51,0x00,0xF2,0x00,0x00,0x0F,0xFF} },
...
static struct mtk_panel_params ext_params_60hz = {
	...
	.dyn_fps = {
		.switch_en = 1,
		.vact_timing_fps = 120,
		.dfps_cmd_table[0] = {30, 2, {0x38, 0x00} },
				 ...
				 unsigned int level)
{
	...
	char peak_on[] = {0x5f, 0x05};
	char peak_off[] = {0x5f, 0x00};
	...
	if (level == PEAK_ON_BL && !peak_mode_enable) {
		cb(dsi, handle, peak_on, ARRAY_SIZE(peak_on));
		peak_mode_enable = 1;
	} else if (peak_mode_enable && level < PEAK_ON_BL) {
		cb(dsi, handle, peak_off, ARRAY_SIZE(peak_off));
		peak_mode_enable = 0;
	}
			...
			struct drm_connector *connector, unsigned int mode)
{
	...
	if (dst_fps == 30) {
		if (panel_ctx->doze_brightness_state == DOZE_BRIGHTNESS_HBM) {
			ext_params_30hz.dyn_fps.dfps_cmd_table[0].para_list[1] = (doze_hbm_dbv_level >>8) & 0xFF;
			ext_params_30hz.dyn_fps.dfps_cmd_table[0].para_list[2] = doze_hbm_dbv_level & 0xFF;
			ext_params_30hz.dyn_fps.dfps_cmd_table[0].para_list[5] = 0x0F;
			ext_params_30hz.dyn_fps.dfps_cmd_table[0].para_list[6] = 0xFF;
		} else if (panel_ctx->doze_brightness_state == DOZE_BRIGHTNESS_LBM) {
			ext_params_30hz.dyn_fps.dfps_cmd_table[0].para_list[1] = (doze_lbm_dbv_level >>8) & 0xFF;
			ext_params_30hz.dyn_fps.dfps_cmd_table[0].para_list[2] = doze_lbm_dbv_level & 0xFF;
			ext_params_30hz.dyn_fps.dfps_cmd_table[0].para_list[5] = 0x01;
			ext_params_30hz.dyn_fps.dfps_cmd_table[0].para_list[6] = 0x55;
		}
...
int panel_get_wp_info(struct drm_panel *panel, char *buf, size_t size)
{
	...
	if (sscanf(oled_wp_cmdline, "%02hhx%02hhx%02hhx\n",
			&rx_buf[0], &rx_buf[1], &rx_buf[2]) == 3) {
	...
	/* rx_buf[0] is lux(HEX), rx_buf[1] is wx(HEX), rx_buf[2] is wy(HEX) */
	lux = rx_buf[0];
	wx = rx_buf[1];
	wy = rx_buf[2];
...
MODULE_DESCRIPTION("o16u_36_02_0b_dsc_vdo oled panel driver");
MODULE_LICENSE("GPL");

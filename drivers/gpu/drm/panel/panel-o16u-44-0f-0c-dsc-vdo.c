...
#define AOD_INIT_STATUS 4		// 90 00 exit aod;  90 01 entern aod
...
static int doze_hbm_dbv_level = 4094;
static int doze_lbm_dbv_level = 341;
...
static unsigned int current_lhbm_state = TYPE_LHBM_OFF;
...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0x9F, 1,{0x02}},
	{0xE7, 8,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xC8}},
	...
	{0x9F, 0x01, {0x01}},
	{0xE2, 0x02, {0x46,0x20}},
	{0xEA, 0x02,{0x04,0x00}},//VIDEOPACKETFORCE0BW6/JINGCENEED///DEFAULTSETREA0400
	{0xE4, 0x08,{0x00,0x00,0x80,0x0C,0xFF,0x0F,0x08,0x00}},
	{0xCA, 0x14,{0x05,0x01,0x00,0x02,0x02,0x03,0xD6,0x03,0x03,0x03,0xD6,0x03,0x03,0x03,0xD6,0x03,0x03,0x88,0xAA,0x81}},
	{0xCB, 0x0F,{0x01,0x02,0x02,0x03,0xD6,0x03,0x03,0x03,0xD6,0x03,0x03,0x03,0xD6,0x03,0x03}},
	{0xD3, 0x02,{0xA0,0x00}},
	{0x9F, 0x01,{0x02}},
	{0xED, 0x03,{0x00,0x01,0x80}},
	{0xEE, 0x11,{0x05,0x00,0x00,0x00,0x00,0x88,0x00,0x00,0x00,0x30,0x88,0x88,0x29,0x00,0x00,0x00,0x00}},
	{0xD9, 0x0B,{0x10,0x40,0x20,0x00,0x20,0x00,0x20,0x00,0x20,0x00,0x20}},
	{0x9F, 0x01, {0x03}},
	{0xB2, 0x20, {0x11,0x00,0x00,0xAB,0x30,0x80,0x0A,0x98,0x04,0xC4,0x00,0x0C,0x02,0x62,0x02,0x62,0x02,0x00,0x02,0x32,0x00,0x20,0x01,0x31,0x00,0x08,0x00,0x0C,0x08,0xBB,0x07,0x7B}},
	{0xB3, 0x20, {0x18,0x00,0x10,0xF0,0x07,0x10,0x20,0x00,0x06,0x0F,0x0F,0x33,0x0E,0x1C,0x2A,0x38,0x46,0x54,0x62,0x69,0x70,0x77,0x79,0x7B,0x7D,0x7E,0x02,0x02,0x22,0x00,0x2A,0x40}},
	{0xB4, 0x18, {0x2A,0xBE,0x3A,0xFC,0x3A,0xFA,0x3A,0xF8,0x3B,0x38,0x3B,0x78,0x3B,0xB6,0x4B,0xB6,0x4B,0xF4,0x4B,0xF4,0x6C,0x34,0x84,0x74}},
...
static const char *panel_name = "panel_name=dsi_o16u_44_0f_0c_dsc_vdo";
...
static struct LCM_setting_table lhbm_normal_white_1200nit[] = {
	...
	{0x9F, 0x01,{0x0C}},
	{0xB4, 0x01,{0xF1}},//F0:DATAREMAPOFFF1:DATAREMAPON
	{0x9F, 0x01,{0x04}},
	{0xB5, 0x0D,{0x40,0x1F,0x29,0x61,0x85,0x00,0x6A,0x6A,0x36,0x3F,0xFF,0xFF,0xFF}},
	{0xBE, 0x12,{0x31,0x01,0x3F,0xFF,0xFF,0xFF,0x3F,0xF7,0xF5,0xF8,0x3F,0xFF,0xFF,0xFF,0x3F,0xFF,0xFF,0xFF}},//FPS_INTER_EN=1,FPS_MAN_CIR=0,ACL_CUR_EN=1
	// CIRCLE DBV GAIN
	{0xE9, 0x2D,{0x44,0x15,0x35,0x32,0x51,0xC2,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x44,0x15,0x35,0x32,0x51,0xC2,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x44,0x15,0x35,0x32,0x51,0xC2,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x22,0x8F,0x8F}},
	{0xEB, 0x2D,{0x55,0x32,0x76,0x44,0xB9,0x2F,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x55,0x32,0x76,0x44,0xB9,0x2F,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x55,0x32,0x76,0x44,0xB9,0x2F,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x33,0xFC,0xFC}},
	{0xED, 0x2D,{0x22,0x45,0x94,0x10,0x74,0xA5,0x00,0x65,0x65,0x00,0x65,0x65,0x00,0x65,0x65,0x22,0x45,0x94,0x10,0x74,0xA5,0x00,0x65,0x65,0x00,0x65,0x65,0x00,0x65,0x65,0x22,0x45,0x94,0x10,0x74,0xA5,0x00,0x65,0x65,0x00,0x65,0x65,0x00,0x65,0x65}},
	//// CIRCLE APL GAIN
	{0xFB, 0x1C,{0x0A,0x0E,0x01,0x00,0x00,0x23,0x00,0x00,0x45,0x00,0x00,0x67,0x00,0x00,0x89,0x00,0x00,0xAB,0x00,0x00,0xCD,0x00,0x00,0xEF,0x00,0x00,0xF0,0xFF}},//ACLTH
	{0xFC, 0x1A,{0xFF,0x60,0x60,0xFF,0x60,0x6B,0xFF,0x77,0x82,0xFF,0x8D,0x99,0xFF,0xA4,0xAF,0xFF,0xBB,0xC6,0xFF,0xD2,0xDD,0xFF,0xE8,0xF4,0xF0,0xFF}},
	{0xFE, 0x1A,{0xFF,0x47,0x47,0xFF,0x47,0x54,0xFF,0x62,0x6F,0xFF,0x7C,0x89,0xFF,0x96,0xA3,0xFF,0xB0,0xBD,0xFF,0xCB,0xD8,0xFF,0xE5,0xF2,0xF0,0xFF}},
	{0xFF, 0x1A,{0xFF,0x5B,0x5B,0xFF,0x5B,0x66,0xFF,0x72,0x7E,0xFF,0x8A,0x95,0xFF,0xA1,0xAD,0xFF,0xB9,0xC4,0xFF,0xD0,0xDC,0xFF,0xE8,0xF3,0xF0,0xFF}},
	{0x9F, 0x01,{0x05}},
	{0xB3, 0x08,{0x24,0x00,0x28,0x00,0x00,0x40,0x3F,0xFF}},//DBV_12B_SEL=1,FPS_EN=0/FPS_EN_PWM=0
	{0xB4, 0x0C,{0x02,0x0E,0x3E,0x00,0x00,0x10,0x06,0x00,0x00,0x02,0x50,0x8D}},//ALPHAMODE
	{0xE6, 0x16,{0x1F,0xFE,0x0F,0xFE,0x0B,0x32,0x06,0x66,0x02,0x8E,0x02,0x8C,0x01,0x96,0x00,0xCE,0x00,0x52,0x00,0x10,0x00,0x00}},//DBVBAND:81904094286616386546524062068216
	{0xE8, 0x16,{0x0F,0xFF,0x0F,0xFF,0x0F,0xFF,0x0F,0xFF,0x0F,0xFF,0x0F,0xFA,0x0A,0x3E,0x06,0x37,0x04,0x89,0x02,0xFE,0x00,0x00}},
	{0x97, 0x02,{0x11,0x80}},//FPSON
...
static struct LCM_setting_table lhbm_normal_white_250nit[] = {
	...
	{0x9F, 0x01,{0x04}},
	{0xB5, 0x0D,{0x40,0x1F,0x29,0x61,0x85,0x00,0x6A,0x6A,0x36,0x3F,0xFF,0xFF,0xFF}},
	{0xBE, 0x12,{0x31,0x01,0x2E,0xF5,0x0B,0xF6,0x2A,0xEB,0xFB,0xF0,0x3F,0x00,0x00,0x00,0x2A,0xF0,0xFF,0xF7}},//FPS_INTER_EN=1,FPS_MAN_CIR=0,ACL_CUR_EN=1
	// CIRCLE DBV GAIN
	{0xE9, 0x2D,{0x44,0x15,0x35,0x32,0x51,0xC2,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x44,0x15,0x35,0x32,0x51,0xC2,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x44,0x15,0x35,0x32,0x51,0xC2,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x22,0x8F,0x8F}},
	{0xEB, 0x2D,{0x55,0x32,0x76,0x44,0xB9,0x2F,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x55,0x32,0x76,0x44,0xB9,0x2F,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x55,0x32,0x76,0x44,0xB9,0x2F,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x33,0xFC,0xFC}},
	{0xED, 0x2D,{0x22,0x45,0x94,0x10,0x74,0xA5,0x00,0x65,0x65,0x00,0x65,0x65,0x00,0x65,0x65,0x22,0x45,0x94,0x10,0x74,0xA5,0x00,0x65,0x65,0x00,0x65,0x65,0x00,0x65,0x65,0x22,0x45,0x94,0x10,0x74,0xA5,0x00,0x65,0x65,0x00,0x65,0x65,0x00,0x65,0x65}},
...
static struct LCM_setting_table lhbm_normal_green_500nit[] = {
	...
	{0x9F, 0x01,{0x04}},
	{0xB5, 0x0D,{0x40,0x1F,0x29,0x61,0x85,0x00,0x6A,0x6A,0x36,0x3F,0xFF,0xFF,0xFF}},
	{0xBE, 0x12,{0x31,0x01,0x1C,0xFF,0xA0,0x00,0x1C,0xFF,0x98,0x00,0x0C,0x00,0xA8,0x00,0x2C,0x00,0xA0,0xFF}},//FPS_INTER_EN=1,FPS_MAN_CIR=0,ACL_CUR_EN=1
	// CIRCLE DBV GAIN
	{0xE9, 0x2D,{0x44,0x15,0x35,0x32,0x51,0xC2,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x44,0x15,0x35,0x32,0x51,0xC2,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x44,0x15,0x35,0x32,0x51,0xC2,0x22,0x8F,0x8F,0x22,0x8F,0x8F,0x22,0x8F,0x8F}},
	{0xEB, 0x2D,{0x55,0x32,0x76,0x44,0xB9,0x2F,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x55,0x32,0x76,0x44,0xB9,0x2F,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x55,0x32,0x76,0x44,0xB9,0x2F,0x33,0xFC,0xFC,0x33,0xFC,0xFC,0x33,0xFC,0xFC}},
	{0xED, 0x2D,{0x22,0x45,0x94,0x10,0x74,0xA5,0x00,0x65,0x65,0x00,0x65,0x65,0x00,0x65,0x65,0x22,0x45,0x94,0x10,0x74,0xA5,0x00,0x65,0x65,0x00,0x65,0x65,0x00,0x65,0x65,0x22,0x45,0x94,0x10,0x74,0xA5,0x00,0x65,0x65,0x00,0x65,0x65,0x00,0x65,0x65}},
...
static struct LCM_setting_table off_lhbm_normal_white_1200nit[] = {
	//UNLOCK
	{0x9C, 0x02,{0xA5,0xA5}},
	{0xFD, 0x02,{0x5A,0x5A}},
...
static struct LCM_setting_table off_lhbm_normal_white_250nit[] = {
	//UNLOCK
	{0x9C, 0x02, {0xA5,0xA5}},
	{0xFD, 0x02, {0x5A,0x5A}},
...
static struct LCM_setting_table off_lhbm_normal_green_500nit[] = {
	//UNLOCK
	{0x9C, 0x2,{0xA5,0xA5}},
	{0xFD, 0x2,{0x5A,0x5A}},
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	if (ctx->dynamic_fps == 120) {
#endif
		if (init_setting_vdo[FPS_INIT_INDEX].cmd == 0x48) {
			init_setting_vdo[AOD_INIT_STATUS].para_list[0] = 0x00;
			init_setting_vdo[FPS_INIT_INDEX].para_list[0] = 0x23;
		} else {
		...
		if (init_setting_vdo[FPS_INIT_INDEX].cmd == 0x48) {
			init_setting_vdo[AOD_INIT_STATUS].para_list[0] = 0x00;
			init_setting_vdo[FPS_INIT_INDEX].para_list[0] = 0x13;
		} else {
			pr_info("%s: please check FPS_INIT_INDEX\n", __func__);
		}
		...
		if (init_setting_vdo[FPS_INIT_INDEX].cmd == 0x48) {
			init_setting_vdo[AOD_INIT_STATUS].para_list[0] = 0x00;
			init_setting_vdo[FPS_INIT_INDEX].para_list[0] = 0x03;
		} else {
			pr_info("%s: please check FPS_INIT_INDEX\n", __func__);
		}
	}
...
#define HBP                (4)
#ifdef ENABLE_30HZ
#define HFP_30HZ           (1576)
#endif

#define VFP_120HZ          (56)
#define VFP_90HZ           (936)
#define VFP_60HZ           (2872)
#define VSA                (1)
#define VBP                (47)
...
static const struct drm_display_mode mode_30hz = {
	.clock = (FRAME_WIDTH + HFP_30HZ + HSA + HBP) * (FRAME_HEIGHT + VFP_120HZ + VSA + VBP) * MODE_0_FPS / 1000,
...
static const struct drm_display_mode mode_60hz = {
	.clock = (FRAME_WIDTH + HFP + HSA + HBP) * (FRAME_HEIGHT + VFP_60HZ + VSA + VBP) * MODE_1_FPS / 1000,
	.hdisplay = FRAME_WIDTH,
...
static const struct drm_display_mode mode_90hz = {
	.clock = (FRAME_WIDTH + HFP + HSA + HBP) * (FRAME_HEIGHT + VFP_90HZ + VSA + VBP) * MODE_2_FPS / 1000,
	.hdisplay = FRAME_WIDTH,
	.hsync_start = FRAME_WIDTH + HFP,		//HFP
	.hsync_end = FRAME_WIDTH + HFP + HSA,		//HSA
	.htotal = FRAME_WIDTH + HFP + HSA + HBP,		//HBP
...
static struct mtk_panel_params ext_params_30hz = {
	...
	.dyn_fps = {
		...
		.dfps_cmd_table[1] = {0, 3, {0x51,0x0F,0xFE} },
...
static struct LCM_setting_table lcm_peak_mode_on[] = {
	...
	{0xFD, 0x2,{0x5A,0x5A}},
	{0x9F, 0x01,{0x08}},
	{0xD6, 0x34,{0xF0,0x00,0x12,0x63,0xCC,0x45,
				0x2D,0x84,0x68,0xEA,0x37,0x9A,
				0x7C,0xB4,0xBD,0xDE,0x00,0xEF,
				0x19,0x33,0x01,0x5C,0x96,0x24,
				0xEE,0x66,0xE0,0x00,0x12,0x63,
				0xCC,0x45,0x2D,0x84,0x68,0xD2,
				0x16,0x9A,0x51,0x7A,0xBC,0x9A,
				0xAD,0xDE,0xB7,0xBB,0xF0,0xBD,
				0xBD,0x12,0xBA,0xC8}},
	{0xD7, 0x01A,{0xF0,0x00,0x12,0x63,0xCC,0x45,
				0x2D,0x84,0x78,0x0B,0x5C,0x9A,
				0xA4,0xDD,0xCD,0x0D,0x38,0xEF,
				0x50,0x6E,0x01,0x89,0xAD,0x24,
				0xE9,0x40}},
	{0xCC, 0x04,{0x02,0xFF,0x10,0x14}},
	{0x51, 0x02,{0x0F,0xFF}},
	{0x9F, 0x01,{0x0C}},
				 ...
				 unsigned int level)
{
	...
	if (level == PEAK_ON_BL && !peak_mode_enable) {
		...
		lcm_peak_mode_off[7].para_list[0] = bl_tb0[1];
		lcm_peak_mode_off[7].para_list[1] = bl_tb0[2];
...
int panel_get_wp_info(struct drm_panel *panel, char *buf, size_t size)
{
	...
	if (sscanf(oled_wp_cmdline, "%02hhx%02hhx%02hhx%02hhx\n",
			&rx_buf[0], &rx_buf[1], &rx_buf[2], &rx_buf[3]) == 4) {
	...
	/* rx_buf[0-1] is lux(HEX), rx_buf[2] is wx(HEC), rx_buf[3] is wy(HEC) */
	lux = rx_buf[0] << 8 | rx_buf[1];
	wx = rx_buf[2];
	wy = rx_buf[3];
...
static int panel_fod_lhbm_init (struct mtk_dsi* dsi)
{
	...
	dsi->mi_cfg.lhbm_ui_ready_delay_frame = 8;
	dsi->mi_cfg.lhbm_ui_ready_delay_frame_aod = 8;
...
static int panel_set_lhbm_fod(struct mtk_dsi *dsi, enum local_hbm_state lhbm_state)
{
	...
	case LOCAL_HBM_OFF_TO_NORMAL_BACKLIGHT:
		...
		if (TYPE_WHITE_1200 == current_lhbm_state) {
			mi_disp_panel_ddic_send_cmd(off_lhbm_normal_white_1200nit, ARRAY_SIZE(off_lhbm_normal_white_1200nit), false);
			pr_info("lhbm_normal_white_1200nit off.");
		} else if (TYPE_WHITE_250 == current_lhbm_state) {
			mi_disp_panel_ddic_send_cmd(off_lhbm_normal_white_250nit, ARRAY_SIZE(off_lhbm_normal_white_250nit), false);
			pr_info("lhbm_normal_white_250nit off.");
		} else if (TYPE_GREEN_500 == current_lhbm_state) {
			mi_disp_panel_ddic_send_cmd(off_lhbm_normal_green_500nit, ARRAY_SIZE(off_lhbm_normal_green_500nit), false);
			pr_info("lhbm_normal_green_500nit off.");
		}
	...
	case LOCAL_HBM_OFF_TO_NORMAL_BACKLIGHT_RESTORE:
		...
		mi_cfg->lhbm_en = false;
		mi_disp_panel_ddic_send_cmd(lcm_backlight_off, ARRAY_SIZE(lcm_backlight_off),false);
	...
	case LOCAL_HBM_NORMAL_WHITE_110NIT:
		...
		current_lhbm_state = TYPE_WHITE_250;
	...
	case LOCAL_HBM_NORMAL_GREEN_500NIT:
		...
		current_lhbm_state = TYPE_GREEN_500;
	...
	case LOCAL_HBM_NORMAL_WHITE_1000NIT:
		...
		current_lhbm_state = TYPE_WHITE_1200;
	...
	if (DOZE_BRIGHTNESS_LBM  == doze_brightness || DOZE_BRIGHTNESS_HBM  == doze_brightness) {
		if (DOZE_BRIGHTNESS_LBM  == doze_brightness) {
			...
			if (globle_mtk_dsi->mi_cfg.lhbm_en) {
				ret = mi_disp_panel_ddic_send_cmd(lcm_aod_low_mode_with_lhbm_alpha, ARRAY_SIZE(lcm_aod_low_mode_with_lhbm_alpha), false);
			} else {
				ret = mi_disp_panel_ddic_send_cmd(lcm_aod_low_mode, ARRAY_SIZE(lcm_aod_low_mode), false);
			}
		} else if (DOZE_BRIGHTNESS_HBM == doze_brightness) {
			...
			if (globle_mtk_dsi->mi_cfg.lhbm_en) {
				ret = mi_disp_panel_ddic_send_cmd(lcm_aod_high_mode_with_lhbm_alpha, ARRAY_SIZE(lcm_aod_high_mode_with_lhbm_alpha), false);
			} else {
				ret = mi_disp_panel_ddic_send_cmd(lcm_aod_high_mode, ARRAY_SIZE(lcm_aod_high_mode), false);
			}
		}
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s+ o16u_44_0f_0c_dsc_vdo\n", __func__);
...
MODULE_DESCRIPTION("o16u_44_0f_0c_dsc_vdo oled panel driver");
MODULE_LICENSE("GPL");

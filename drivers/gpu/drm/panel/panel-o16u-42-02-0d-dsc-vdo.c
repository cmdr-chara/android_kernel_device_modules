...
#include "include/panel_o16u_42_02_0d_alpha_data.h"
...
static const char *panel_name = "panel_name=dsi_o16u_42_02_0d_dsc_vdo";
...
MODULE_DESCRIPTION("o16u_42_02_0d_dsc_vdo oled panel driver");
MODULE_LICENSE("GPL");
